...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        NewWodButton->setGeometry(QRect(20, 190, 171, 81));
        ...
        NewWodButton->setPalette(palette);
        NewWodButton->setStyleSheet(QString::fromUtf8("url:/new/prefix1/ico/15 - \320\272\320\276\320\277\320\270\321\217.png"));
        WodButton = new QPushButton(centralWidget);
        WodButton->setObjectName(QStringLiteral("WodButton"));
        WodButton->setGeometry(QRect(20, 40, 171, 81));
        WodButton->setMaximumSize(QSize(171, 81));
        QPalette palette1;
        palette1.setBrush(QPalette::Active, QPalette::Button, brush);
        palette1.setBrush(QPalette::Inactive, QPalette::Button, brush);
        palette1.setBrush(QPalette::Disabled, QPalette::Button, brush);
        WodButton->setPalette(palette1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        NewWodButton->setText(QApplication::translate("MainWindow", "New WOD", 0));
        WodButton->setText(QApplication::translate("MainWindow", "Select WOD", 0));
